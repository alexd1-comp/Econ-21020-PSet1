...
Thus, $\sqrt{n}(\hat{\mu}^2_{Y\mid1} - {\mu}^2_{Y\mid1})$ / $\sqrt{\hat{\sigma}^2_{Y\mid1}/\hat{p}_X}$ $\xrightarrow{d}$ N(0,1).
...
10 - 1.96(3), 10 + 1.96(3) = (4.12, 15.88)

I reject $H_{0}$ at the 5\% significance level, as (E[Y$\mid X = 1])$ = 4 is less than 4.12, which was the lower bound of the confidence interval.
